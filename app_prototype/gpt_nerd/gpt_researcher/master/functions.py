import asyncio
from gpt_nerd.gpt_researcher.utils.llm import *
from gpt_nerd.gpt_researcher.scraper import Scraper
from gpt_nerd.gpt_researcher.master.prompts import *
import json
...
def get_retriever(retriever):
    ...
    match retriever:
        case "tavily":
            from gpt_nerd.gpt_researcher.retrievers import TavilySearch
            retriever = TavilySearch
        case "google":
            from gpt_nerd.gpt_researcher.retrievers import GoogleSearch
            retriever = GoogleSearch
        case "searx":
            from gpt_nerd.gpt_researcher.retrievers import SearxSearch
        ...
        case "googleSerp":
            from gpt_nerd.gpt_researcher.retrievers import SerperSearch
            retriever = SerperSearch
        case "duckduckgo":
            from gpt_nerd.gpt_researcher.retrievers import Duckduckgo
