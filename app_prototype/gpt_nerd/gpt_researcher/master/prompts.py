...
def generate_report_prompt(question, context, report_format="apa", total_words=800):
...
def auto_agent_instructions():
    return """
        ...
        task: "What are the risks of investing in the agriculture section in Salo?"
        response: 
        { 
            "server":  "📈 Investment analyst specializing in Finlands markets",
            "agent_role_prompt": "You are an experienced AI Investment analyst. Your main objective is to produce comprehensive, insightful, impartial, and systematically structured reports based on demographic and trade data, market trends, and strategic analysis. Your focus is on Finland."
        }
    """
